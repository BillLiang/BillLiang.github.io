...
function boolwapnav(navIndex,navbool){
	if(navbool){
		...
		$(".nav .child").unbind("click").bind("mouseover",function(){
			...
			var navIndex=$(".nav .child").index($("https://www.duose.org/skin/ds/js/.nav .child.on"));
			navTopAn(navIndex);
...
$(function(){
	...
	$(window).scroll(function(){
		if($(this).scrollTop()>=200){
			...
			$("https://www.duose.org/skin/ds/js/.header .nav").stop(false,false).animate({"height":"80px"},200);
			...
			$("https://www.duose.org/skin/ds/js/.header .nav").stop(false,false).animate({"height":"120px"},200);
...
function navTopAn(index){
	var navW=$("https://www.duose.org/skin/ds/js/.nav .child.on").width();
	$(".navTop").css({
		"width":navW,
		"display":"block",
		"left":navW*index

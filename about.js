...
$(function(){
	...
	$(".customer .customerBtn").mouseover(function(){
		...
		if(imageSrc.indexOf("On.png"/*tpa=https://www.duose.org/skin/ds/js/On.png*/)>0){}else{
			imageSrc=imageSrc.replace(".png","On.png"/*tpa=https://www.duose.org/skin/ds/js/On.png*/);
		}
		$(this).attr("src",imageSrc);
	}).mouseleave(function(){
		var imageSrc=$(this).attr("src");
		if(imageSrc.indexOf("On.png"/*tpa=https://www.duose.org/skin/ds/js/On.png*/)>0){
			imageSrc=imageSrc.replace("On.png"/*tpa=https://www.duose.org/skin/ds/js/On.png*/,".png");
		}else{}
		$(this).attr("src",imageSrc);
	});
});